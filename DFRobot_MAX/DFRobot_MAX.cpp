...
static uint16_t _bitmap[8] = {0,0,0,0,0,0,0,0};
...
void DFRobot_MAX::rgbLed(int ledn, uint8_t r, uint8_t g, uint8_t b)
{
	if(ledn != -1)
		...
		led_.setPixelColor(1, led_.Color(r, g, b) );
		led_.setPixelColor(2, led_.Color(r, g, b) );
		led_.setPixelColor(3, led_.Color(r, g, b) );
	}
	led_.show();
}
